...
Description: Anime Release Tracker is a web application that helps fans keep track of upcoming and currently airing anime episodes in one centralized place. Instead of checking multiple sources like MyAnimeList, AniList, and streaming platforms, users can view a weekly release schedule, search for titles, and save shows to a watchlist.
...
Vercel automatically deploys the project
...
Row Level Security: Disabled for class demo purposes.
